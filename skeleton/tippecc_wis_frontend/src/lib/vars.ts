//aoi [lat min, lat max, lon min, lon max]
...
//variable for file ids
export let file_ids: string[] 
export function updateFileIds (file_id_dict: {name: string, count: number}[]){
	file_ids = []
	for (let file of file_id_dict){
